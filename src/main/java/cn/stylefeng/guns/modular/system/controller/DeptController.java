...
public class DeptController extends BaseController {
    ...
    public Object getParent() {
        List<Map<String,Object>> list=deptService.getParentById();
    ...
    @ResponseBody
    public Object getChild(@PathVariable("id") Integer id) {
        //System.out.println(id);
        List<Map<String,Object>> list=deptService.getChildDeptById(id);
        //System.out.println(list);
        return list;
    }
     ...
     * 获取子部门
     */
    @RequestMapping("/getChild2")
    @ResponseBody
    public Object getChild2(Integer bid) {
        //System.out.println(id);
        List<Map<String,Object>> list=deptService.getChildDeptById(bid);
        //System.out.println(list);
        return list;
    }
    ...
    public Object getDept(@PathVariable("id") Integer id) {
        //System.out.println(id);
        List<Map<String,Object>> list=deptService.getDeptById(id);
        System.out.println(list);
        return list;
    }
